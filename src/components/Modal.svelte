<script>
  ...
  export let bgClass = { top: 0, left: 0 };
...
{#if Component}
  ...
  >
    <div class="window-wrap" bind:this={wrap}>
      <div
        class="window {state.windowClass}"
        role="dialog"
        aria-modal="true"
      ...
      >
        {#if state.closeButton}
          ...
          {:else}
            <button on:click={close} class="close {state.closeButtonClass}" style={cssCloseButton} />
          {/if}
        {/if}
        <div class="content {state.contentClass}" style={cssContent}>
